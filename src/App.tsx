...
const LINKS = {
  ...
  linkedin: "https://www.linkedin.com/in/amir-bomba",
  resume: "/Amir-Bomba-CV.pdf",
};

const PROFILE = {
  name: "Amir Bomba",
  tagline: "CS student • Math tutor • Builder of useful automations",
  location: "Philadelphia, PA · Addis Ababa, ET · Nairobi, KE",
};
...
const PROJECTS: Project[] = [
  {
    ...
    links: { code: "https://github.com/ABomba06/Crypto-Momentum-Bot" },
  },
  {
    ...
    links: { code: "https://github.com/ABomba06/sheets-dashboard" },
  },
  {
    title: "GameHub Catalog",
    desc: "A Catalog of Popular Games.",
    stack: ["React", "Chakra UI", "RAWG API"],
    links: { code: "https://github.com/ABomba06/Game-Hub" },
  },
];
...
const EXPERIENCE: Experience[] = [
  ...
  {
    company: "Private Math/Physics Tutor",
    role: "Tutor (College Level)",
    period: "Summer 2025 · International",
    bullets: [
      "Tutored Calculus and Calculus based General Physics 1-on-1.",
...
export default function App() {
  ...
  return (
    ...
    <Box w="full" maxW="7xl" px={{ base: 4, md: 6 }} py={{ base: 8, md: 10 }}>
        ...
        <Section title="Projects">
          <SimpleGrid minChildWidth="320px" spacing={6}>
            {PROJECTS.map((p) => (
              <Card
                key={p.title}
                h="full"
